...
def main():
    ...
    parser.add_argument('--adata_file', type=str, required=True,
                       help='Path to the h5ad file containing the AnnData object, ex) FINAL/sub_clustering/NORMAL_total_annotation_240413_noRBCPlatelet.h5ad')
    parser.add_argument('--filename', type=str, required=True,
                       help='Path to the TSV file containing eGene data, ./Immune_response_eGene.tsv')
    ...
    parser.add_argument('--annotation_name', type=str, required=True,
                       help='Name of the annotation field in adata.obs, ex) HWannot_Broad')
